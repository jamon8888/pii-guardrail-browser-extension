...
export const NER_THRESHOLD_BY_ENTITY_TYPE: Readonly<Record<EntityType, number>> = {
  ...
  VEHICLE_IDENTIFIER: 0.80,
  CONTACT_HANDLE: 0.70,
  HEALTH_DATA: 0.70,
  BIOMETRIC_DATA: 0.70,
  GENETIC_DATA: 0.70,
  RELIGION_OR_BELIEF: 0.70,
  POLITICAL_OPINION: 0.70,
  TRADE_UNION_MEMBERSHIP: 0.70,
  ETHNIC_ORIGIN: 0.70,
  SEXUAL_ORIENTATION: 0.70,
  CRIMINAL_OFFENCE_DATA: 0.70,
};
